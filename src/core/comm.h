...
#define coM_newmem(Co, s) coM_xllocmem(Co, NULL, 0, (s))
#define coM_deletemem(Co, p, s) coM_xllocmem(Co, (p), (s), 0)
#define coM_newobj(Co, t) co_cast(t*, coM_xllocmem(Co, NULL, 0, sizeof(t)))
